...
const adverbDistractorMap = {
  "따뜻하게": ["빠른", "높이", "깡충깡충", "시끄러운", "노란"],
  "맑게": ["두꺼운", "깜깜한", "느릿느릿", "알록달록한", "주렁주렁"],
  "신나게": ["부드러운", "노래하는", "폴짝폴짝", "심심한", "단단한"],
  "가득히": ["빠른", "두꺼운", "큰", "납작한", "푸르게"],
  "심심하게": ["힘찬", "쑥쑥", "짧게", "신나는", "즐거운"],

  "아름답게": ["높이", "빠른", "깔깔", "짧게", "강한"],
  "알록달록하게": ["단단한", "조용한", "심심한", "커다란", "후드득"],
  "얇게": ["큰", "깜깜하게", "짧은", "훨훨", "힘찬"],
  "예쁘게": ["와글와글", "조용한", "강한", "두꺼운", "힘찬"],
  "자세하게": ["데굴데굴", "두꺼운", "예쁜", "작은", "푸른"],

  "작게": ["큰", "힘찬", "가득히", "단단한", "즐거운"],
  "좁게": ["사르르", "푸른", "신나는", "푸른", "멋진"],
  "즐겁게": ["슬픈", "느릿느릿", "주륵주륵", "예쁜", "후드득"],
  "짧게": ["단단한", "높이", "빠른", "두꺼운", "동그란"],
  "커다랗게": ["데굴데굴", "좁은", "짧은", "씽씽", "예쁜"],

  "크게": ["얇은", "큰", "맑은", "살랑살랑", "좁은"],
  "튼튼하게": ["노란", "부드러운", "맑은", "조용한", "느릿느릿"],
  "푸르게": ["두꺼운", "심심한", "붉은", "멋진", "빠른"],
  "하얗게": ["검은", "노란", "작은", "단단한", "덜 자란"],
  "힘차게": ["느릿느릿", "살랑살랑", "가득히", "좋아하는", "좁은"],

  "건강하게": ["작은", "피곤한", "노란", "슬픈", "낮은"],
  "굵게": ["사르르", "작은", "맛있는", "맑은", "튼튼한"],
  "귀엽게": ["둥실둥실", "짧은", "깔깔", "둥근", "좋아하는"],
  "길게": ["살랑살랑", "얇은", "빠른", "둥근", "단단한"],
  "깜깜하게": ["납작한", "환한", "맑은", "두꺼운", "노래하는"],

  "납작하게": ["느린", "긴", "얇은", "두꺼운", "깜깜한"],
  "낮게": ["즐거운", "긴", "째깍째깍", "빠른", "조용한"],
  "넓게": ["좋아하는", "짧은", "작은", "빠른", "살랑살랑"],
  "노랗게": ["두꺼운", "씽씽", "푸른", "깜깜한", "낮은"],
  "높이": ["작은", "짧은", "조용한", "빠른", "느릿느릿"],

  "단단하게": ["부드러운", "심심한", "느릿느릿", "알록달록한", "살랑살랑"],
  "둥글게": ["납작한", "긴", "얇은", "부드러운", "노란"],
  "두껍게": ["얇은", "작은", "짧게", "씽씽", "느릿느릿"],
  "맛있게": ["느릿느릿", "알록달록한", "주륵주륵", "뻣뻣한", "매운"],
  "멋지게": ["심심한", "단단한", "알록달록한", "둥근", "짧은"],

  "부드럽게": ["단단한", "빠른", "조용한", "짧은", "멋진"],
  "빠르게": ["느릿느릿", "살랑살랑", "부드러운", "둥근", "짧은"],
};
