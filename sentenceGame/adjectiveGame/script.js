...
{ sentence: "그림 속에는 ▢ 왕자님이 그려져 있었어요.", answer: "멋진" },
...
const adjectiveDistractorMap = {
  ...
  "맑은": ["단단한", "빠름", "깡충깡충", "시끄러운", "느릿느릿"],
  "배고픈": ["부드러운", "무서운", "작은", "멋진", "따뜻한"],
  "신나는": ["낮게", "알록달록한", "조용한", "느림", "맛있는"],
  ...
  "멋진": ["알록달록하게", "심심함", "두리번두리번", "조용하게", "맑게"],
  "부드러운": ["단단하게", "날카로운", "딱딱한", "지저분한", "느릿느릿"],
